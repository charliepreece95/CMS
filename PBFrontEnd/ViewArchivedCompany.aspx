<%@ Page Title="" Language="C#" MasterPageFile="~/ProjectBank.master" AutoEventWireup="true" CodeFile="ViewArchivedCompany.aspx.cs" Inherits="ViewArchived" %>
    <%--Master Page Link--%>
   ...
   <div class="container4Company">
    ...
    <div class="CompanyOnClickButtons2">
             <a href="DeleteCompany.aspx"><input type="button" id="OptionButton4Company" class="button" name="options" value="Options" /></a>
