<%@ Page Title="" Language="C#" MasterPageFile="~/ProjectBank.master" AutoEventWireup="true" CodeFile="DeleteCompany.aspx.cs" Inherits="DeleteCompany" %>
    <%--Master Page Link--%>
    <asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     ...
     <div class="container4Company">
        <div class="CompanyList1">
            <h1 id="title1">Delete Company</h1>
